...
@Component({
  selector: 'app-filter-internal-storage',
  templateUrl: './filter-internal-storage.component.html',
  styleUrls: ['./filter-internal-storage.component.css']
})
export class FilterInternalStorageComponent implements OnInit {
