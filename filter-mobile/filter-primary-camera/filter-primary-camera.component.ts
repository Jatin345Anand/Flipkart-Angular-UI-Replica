...
@Component({
  selector: 'app-filter-primary-camera',
  templateUrl: './filter-primary-camera.component.html',
  styleUrls: ['./filter-primary-camera.component.css']
})
export class FilterPrimaryCameraComponent implements OnInit {
