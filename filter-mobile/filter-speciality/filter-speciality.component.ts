...
@Component({
  selector: 'app-filter-speciality',
  templateUrl: './filter-speciality.component.html',
  styleUrls: ['./filter-speciality.component.css']
})
export class FilterSpecialityComponent implements OnInit {
