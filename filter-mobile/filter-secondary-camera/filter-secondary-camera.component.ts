...
@Component({
  selector: 'app-filter-secondary-camera',
  templateUrl: './filter-secondary-camera.component.html',
  styleUrls: ['./filter-secondary-camera.component.css']
})
export class FilterSecondaryCameraComponent implements OnInit {
