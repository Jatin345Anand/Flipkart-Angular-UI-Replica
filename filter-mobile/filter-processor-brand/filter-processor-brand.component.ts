...
@Component({
  selector: 'app-filter-processor-brand',
  templateUrl: './filter-processor-brand.component.html',
  styleUrls: ['./filter-processor-brand.component.css']
})
export class FilterProcessorBrandComponent implements OnInit {
