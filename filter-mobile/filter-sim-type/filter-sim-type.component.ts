...
@Component({
  selector: 'app-filter-sim-type',
  templateUrl: './filter-sim-type.component.html',
  styleUrls: ['./filter-sim-type.component.css']
})
export class FilterSimTypeComponent implements OnInit {
