...
@Component({
  selector: 'app-filter-screen-size',
  templateUrl: './filter-screen-size.component.html',
  styleUrls: ['./filter-screen-size.component.css']
})
export class FilterScreenSizeComponent implements OnInit {
