...
@Component({
  selector: 'app-filter-laptop-screen-size',
  templateUrl: './filter-laptop-screen-size.component.html',
  styleUrls: ['./filter-laptop-screen-size.component.css']
})
export class FilterLaptopScreenSizeComponent implements OnInit {
