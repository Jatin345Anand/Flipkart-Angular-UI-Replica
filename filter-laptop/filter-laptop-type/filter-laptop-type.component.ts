...
@Component({
  selector: 'app-filter-laptop-type',
  templateUrl: './filter-laptop-type.component.html',
  styleUrls: ['./filter-laptop-type.component.css']
})
export class FilterLaptopTypeComponent implements OnInit {
