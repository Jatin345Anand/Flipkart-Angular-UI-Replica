...
@Component({
  selector: 'app-filter-laptop-operating-system',
  templateUrl: './filter-laptop-operating-system.component.html',
  styleUrls: ['./filter-laptop-operating-system.component.css']
})
export class FilterLaptopOperatingSystemComponent implements OnInit {
