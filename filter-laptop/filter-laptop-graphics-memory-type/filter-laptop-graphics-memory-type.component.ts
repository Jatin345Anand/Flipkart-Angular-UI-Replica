...
@Component({
  selector: 'app-filter-laptop-graphics-memory-type',
  templateUrl: './filter-laptop-graphics-memory-type.component.html',
  styleUrls: ['./filter-laptop-graphics-memory-type.component.css']
})
export class FilterLaptopGraphicsMemoryTypeComponent implements OnInit {
