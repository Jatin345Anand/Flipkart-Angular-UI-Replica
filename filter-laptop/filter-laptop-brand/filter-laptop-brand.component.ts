...
@Component({
  selector: 'app-filter-laptop-brand',
  templateUrl: './filter-laptop-brand.component.html',
  styleUrls: ['./filter-laptop-brand.component.css']
})
export class FilterLaptopBrandComponent implements OnInit {
