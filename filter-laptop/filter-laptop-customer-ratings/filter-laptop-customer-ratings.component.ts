...
@Component({
  selector: 'app-filter-laptop-customer-ratings',
  templateUrl: './filter-laptop-customer-ratings.component.html',
  styleUrls: ['./filter-laptop-customer-ratings.component.css']
})
export class FilterLaptopCustomerRatingsComponent implements OnInit {
