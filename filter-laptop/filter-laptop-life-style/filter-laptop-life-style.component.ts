...
@Component({
  selector: 'app-filter-laptop-life-style',
  templateUrl: './filter-laptop-life-style.component.html',
  styleUrls: ['./filter-laptop-life-style.component.css']
})
export class FilterLaptopLifeStyleComponent implements OnInit {
