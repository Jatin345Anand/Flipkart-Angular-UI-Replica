...
@Component({
  selector: 'app-filter-laptop-ram',
  templateUrl: './filter-laptop-ram.component.html',
  styleUrls: ['./filter-laptop-ram.component.css']
})
export class FilterLaptopRamComponent implements OnInit {
