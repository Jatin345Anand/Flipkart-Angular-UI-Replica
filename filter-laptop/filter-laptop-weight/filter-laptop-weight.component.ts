...
@Component({
  selector: 'app-filter-laptop-weight',
  templateUrl: './filter-laptop-weight.component.html',
  styleUrls: ['./filter-laptop-weight.component.css']
})
export class FilterLaptopWeightComponent implements OnInit {
