...
@Component({
  selector: 'app-filter-laptop-ram-type',
  templateUrl: './filter-laptop-ram-type.component.html',
  styleUrls: ['./filter-laptop-ram-type.component.css']
})
export class FilterLaptopRamTypeComponent implements OnInit {
