...
@Component({
  selector: 'app-filter-laptop-dedicated-graphics-memory',
  templateUrl: './filter-laptop-dedicated-graphics-memory.component.html',
  styleUrls: ['./filter-laptop-dedicated-graphics-memory.component.css']
})
export class FilterLaptopDedicatedGraphicsMemoryComponent implements OnInit {
