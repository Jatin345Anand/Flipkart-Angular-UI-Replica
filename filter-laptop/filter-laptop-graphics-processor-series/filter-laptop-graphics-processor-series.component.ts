...
@Component({
  selector: 'app-filter-laptop-graphics-processor-series',
  templateUrl: './filter-laptop-graphics-processor-series.component.html',
  styleUrls: ['./filter-laptop-graphics-processor-series.component.css']
})
export class FilterLaptopGraphicsProcessorSeriesComponent implements OnInit {
