...
@Component({
  selector: 'app-filter-laptop-ssd-capacity',
  templateUrl: './filter-laptop-ssd-capacity.component.html',
  styleUrls: ['./filter-laptop-ssd-capacity.component.css']
})
export class FilterLaptopSsdCapacityComponent implements OnInit {
